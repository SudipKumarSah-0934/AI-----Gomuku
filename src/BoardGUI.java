...
public class BoardGUI extends JPanel {
	...
	Image img = Toolkit.getDefaultToolkit().getImage("Decentralize-art.jpg");
	public BoardGUI(int boardWidth, int totalCell) {
		...
		*/
		...
		for(int i=0; i<=totalCell; i++) {
			g2D.drawLine(0, 70+i*cellLength, boardWidth-300, 70+i*cellLength);
		}
	...
	public void drawStone(int posX, int posY, boolean human) {
		...
		g2D.setColor(human ? Color.black : Color.white);
