...
public class ModeAI {
	...
	public class MouseClickHandler implements Runnable{
		...
		public void run() {
			...
			System.out.println("Black: " + MinMax.getScore(board,true,true) + " White: " + MinMax.getScore(board,false,true));
	...
	private int checkWinner() {
		if(MinMax.getScore(board, true, false) >= MinMax.getWinScore()) return 2; //[DON'T DELETE] Black stone, Human Player 
		if(MinMax.getScore(board, false, true) >= MinMax.getWinScore()) return 1;
		return 0;
	}
